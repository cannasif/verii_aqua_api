...
namespace aqua_api.Modules.BatchBalances.Api
{
    [ApiController]
    ...
    public class BatchWarehouseBalanceController : ControllerBase
    {
        ...
        [HttpPost("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<BatchWarehouseBalanceDto>>>> GetAll([FromBody] PagedRequest request)
        {
