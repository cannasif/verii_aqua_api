namespace aqua_api.Modules.ProjectKpis.Application.Dtos
{
    public class ProjectCageDailyKpiSnapshotDto
    {
    ...
    public class CreateProjectCageDailyKpiSnapshotRequest
    {
        public DateTime SnapshotDate { get; set; }
        public long? ProjectId { get; set; }
    }
