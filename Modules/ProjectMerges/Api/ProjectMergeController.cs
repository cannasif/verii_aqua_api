...
namespace aqua_api.Modules.ProjectMerges.Api
{
    [ApiController]
    ...
    public class ProjectMergeController : ControllerBase
    {
        ...
        [HttpPost("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<ProjectMergeDto>>>> GetAll([FromBody] PagedRequest request)
        {
