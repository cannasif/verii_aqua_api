...
namespace aqua_api.Modules.GoodsReceipts.Api
{
    [ApiController]
    ...
    public class GoodsReceiptLineController : ControllerBase
    {
        ...
        [HttpPost("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<GoodsReceiptLineDto>>>> GetAll([FromBody] PagedRequest request)
        {
