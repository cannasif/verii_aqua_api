...
namespace aqua_api.Modules.Weighings.Api
{
    [ApiController]
    ...
    public class WeighingLineController : ControllerBase
    {
        ...
        [HttpPost("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<WeighingLineDto>>>> GetAll([FromBody] PagedRequest request)
        {
        ...
        public async Task<ActionResult<ApiResponse<WeighingLineDto>>> CreateWithAutoHeader([FromBody] CreateWeighingLineWithAutoHeaderDto dto)
        {
