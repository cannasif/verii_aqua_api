...
namespace aqua_api.Modules.Transfers.Api
{
    ...
    public class CageWarehouseTransferLineController : ControllerBase
    {
        ...
        [HttpPost("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<CageWarehouseTransferLineDto>>>> GetAll([FromBody] PagedRequest request)
        {
        ...
        public async Task<ActionResult<ApiResponse<CageWarehouseTransferLineDto>>> CreateWithAutoHeaderAndPost([FromBody] CreateCageWarehouseTransferLineWithAutoHeaderDto dto)
        {
