...
namespace aqua_api.Modules.Transfers.Api
{
    ...
    public class TransferLineController : ControllerBase
    {
        ...
        [HttpPost("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<TransferLineDto>>>> GetAll([FromBody] PagedRequest request)
        {
        ...
        public async Task<ActionResult<ApiResponse<TransferLineDto>>> CreateWithAutoHeader([FromBody] CreateTransferLineWithAutoHeaderDto dto)
        {
