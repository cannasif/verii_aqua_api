...
namespace aqua_api.Modules.Transfers.Api
{
    ...
    public class WarehouseCageTransferLineController : ControllerBase
    {
        ...
        [HttpPost("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<WarehouseCageTransferLineDto>>>> GetAll([FromBody] PagedRequest request)
        {
        ...
        public async Task<ActionResult<ApiResponse<WarehouseCageTransferLineDto>>> CreateWithAutoHeaderAndPost([FromBody] CreateWarehouseCageTransferLineWithAutoHeaderDto dto)
        {
