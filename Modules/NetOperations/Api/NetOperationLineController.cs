...
namespace aqua_api.Modules.NetOperations.Api
{
    [ApiController]
    ...
    public class NetOperationLineController : ControllerBase
    {
        ...
        [HttpPost("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<NetOperationLineDto>>>> GetAll([FromBody] PagedRequest request)
        {
        ...
        public async Task<ActionResult<ApiResponse<NetOperationLineDto>>> CreateWithAutoHeader([FromBody] CreateNetOperationLineWithAutoHeaderDto dto)
        {
