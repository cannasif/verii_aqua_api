...
namespace aqua_api.Modules.Cages.Api
{
    [ApiController]
    ...
    public class CageWarehouseMappingController : ControllerBase
    {
        ...
        [HttpPost("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<CageWarehouseMappingDto>>>> GetAll([FromBody] PagedRequest request)
        {
