...
namespace aqua_api.Migrations
{
    ...
    [Migration("20260416063248_WarehouseTransferTables")]
    partial class WarehouseTransferTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("aqua_api.Modules.Aqua.Domain.Entities.BatchMovement", b =>
                {
                    ...
                    b.ToTable("RII_BatchMovement", null, t =>
                        {
                            t.HasCheckConstraint("CK_RII_BatchMovement_MovementType", "[MovementType] IN (0,1,2,3,4,5,6,7,8)");
                        });
                });
