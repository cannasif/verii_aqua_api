...
namespace aqua_api.Migrations
{
    ...
    [Migration("20260628134247_RenameBudgetPlanningTablesToUppercase")]
    partial class RenameBudgetPlanningTablesToUppercase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("aqua_api.Modules.BudgetPlanning.Domain.Entities.BudgetPlanExchangeRate", b =>
                {
                    ...
                    b.HasIndex("BudgetPlanId", "Year", "Month", "CurrencyCode", "RateType")
                        .IsUnique()
                        .HasDatabaseName("UX_RII_BUDGET_PLAN_EXCHANGE_RATE_PeriodCurrency")
                        .HasFilter("[IsDeleted] = 0");
                    ...
                    b.ToTable("RII_BUDGET_PLAN_FEEDING_LINE", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_RII_BUDGET_PLAN_FEEDING_LINE_NonNegative", "[FeedAmountRate] >= 0 AND [FeedKg] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("aqua_api.Modules.BudgetPlanning.Domain.Entities.BudgetPlanFishBatch", b =>
                {
                    ...
                    b.HasIndex("BudgetPlanId", "BatchCode")
                        .HasDatabaseName("IX_RII_BUDGET_PLAN_FISH_BATCH_BatchCode_Active")
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("RII_BUDGET_PLAN_FISH_BATCH", null, t =>
                        {
                            t.HasCheckConstraint("CK_RII_BUDGET_PLAN_FISH_BATCH_GrowthStartMonth", "[GrowthStartMonth] BETWEEN 1 AND 12");

                            t.HasCheckConstraint("CK_RII_BUDGET_PLAN_FISH_BATCH_NonNegative", "[InitialLiveCount] >= 0 AND [InitialAverageGram] >= 0 AND [InitialBiomassKg] >= 0");

                            t.HasCheckConstraint("CK_RII_BUDGET_PLAN_FISH_BATCH_SourceType", "[SourceType] IN (0,1)");
                        });
                });
                    ...
                    b.ToTable("RII_BUDGET_PLAN_MONTHLY_PROJECTION", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_RII_BUDGET_PLAN_MONTHLY_PROJECTION_NonNegative", "[OpeningLiveCount] >= 0 AND [ClosingLiveCount] >= 0 AND [OpeningBiomassKg] >= 0 AND [ClosingBiomassKg] >= 0");
                        });
                });
                    ...
                    b.ToTable("RII_BUDGET_PLAN_MORTALITY_LINE", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_RII_BUDGET_PLAN_MORTALITY_LINE_NonNegative", "[MortalityRatePercent] >= 0 AND [MortalityCount] >= 0 AND [MortalityKg] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("aqua_api.Modules.BudgetPlanning.Domain.Entities.BudgetPlanProject", b =>
                {
                    ...
                    b.HasIndex("BudgetPlanId", "ProjectCode")
                        .HasDatabaseName("IX_RII_BUDGET_PLAN_PROJECT_ProjectCode_Active")
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("RII_BUDGET_PLAN_PROJECT", null, t =>
                        {
                            t.HasCheckConstraint("CK_RII_BUDGET_PLAN_PROJECT_SourceType", "[SourceType] IN (0,1)");
                        });
                });
                    ...
                    b.ToTable("RII_BUDGET_PLAN_SALES_LINE", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_RII_BUDGET_PLAN_SALES_LINE_NonNegative", "[SalesKg] >= 0");
                        });
                });
