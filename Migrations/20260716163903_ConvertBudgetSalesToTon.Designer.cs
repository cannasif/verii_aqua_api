...
namespace aqua_api.Migrations
{
    ...
    [Migration("20260716163903_ConvertBudgetSalesToTon")]
    partial class ConvertBudgetSalesToTon
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("aqua_api.Modules.BudgetPlanning.Domain.Entities.BudgetPlanFishPrice", b =>
                {
                    ...
                    b.HasIndex("BudgetPlanId", "FishStockId", "CalibrationDefinitionId", "Year", "Month")
                        .IsUnique()
                    ...
                    b.ToTable("RII_BUDGET_PLAN_FISH_PRICE", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_RII_BUDGET_PLAN_FISH_PRICE_NON_NEGATIVE", "[UnitPriceEuro] >= 0");
                        });
                });
